...
def main():
    ...
    svgDiagram.save(svgFilename)  # We used same method save
...
def create_diagram(factory):
    ...
    diagram.add(rectangle)  # same method for all diagram classes
    diagram.add(text)  # same method for all diagram classes
    return diagram
