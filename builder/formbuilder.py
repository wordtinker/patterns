...
def create_login_form(builder):
    """
    Accumulate bulding blocks inside builder then flush them with
    form() method instead of having separate constructors with lots of
    parameters. The main purpose is composition.
    """
